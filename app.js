...
app.post("/register/", async (request, response) => {
  ...
  const userDBDetails = await db.get(userDBDetails);
...
app.get("/user/following/", authentication, async (request, response) => {
  ...
  const getFollowingUserQuery = `SELECT name FROM follower INNER JOIN user ON user.user_id = follower.following_user_id WHERE follower_user_id = '${userId}';`;
...
app.get(
  ...
  async (request, response) => {
    ...
    const replyUser = await db.all(getRepliedQuery);
...
app.post("/user/tweets/", authentication, async (request, response) => {
  ...
  const createTweetsQuery = `INSERT INTO tweet (tweet,user_id,date_time) VALUES ('${tweet}', '${userId}', '${dateTime}')`;
